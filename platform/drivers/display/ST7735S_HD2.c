...
/* Display/panel constants (moved out of the SoC registers.h -- these belong to
 * the ST7735S driver, not the HR_C7000 register map): the i8080 write-strobe
 * timing and the panel RESET pin (PTC2, GPIO, active-low). */
